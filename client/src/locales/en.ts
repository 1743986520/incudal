...
4. After creation, ticket details show the ticket ID, state, category, priority, host, and instance; closed tickets cannot receive replies. Never paste an SSH private key, password, or Agent secret into the content or attachments.`
    ...
    host: {
        ...
        migrate: {
            ...
            modeTitle: 'Migration mode',
            forcePanel: 'Force migration from panel',
            forcePanelHint: 'Do not connect to the source host. Create instances on the target and clean up the source instance records in the panel. Use when the source host is dead or was removed by the provider.',
            sourceOfflineHint: 'The source host is not currently online. If communication cannot be restored, enable force migration from panel.',
