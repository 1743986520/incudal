export default {
    ...
    hourlyBilling: {
        badge: 'Hourly',
        createTitle: 'Create Hourly Instance',
        createDescription: 'Pay for actual runtime. The quote updates as resources change.',
        switchToPackage: 'Use package billing',
        disabled: 'Hourly billing is not available yet. Contact an administrator.',
        resourceTitle: 'Resource configuration',
        resourceHint: 'Your balance is settled hourly; stopping the instance pauses resource billing.',
        ...
        memory: 'Memory',
        disk: 'Disk',
        minimumResource: 'Minimum: CPU {cpu}% / memory {memory} MB / disk {disk} MB',
        hostTitle: 'Select host',
        selectHost: 'Select an available host',
        hostUnavailable: 'Insufficient resources',
        noHosts: 'No host is available for this configuration. Reduce resources or try again later.',
        imageTitle: 'Select system image',
        noImages: 'No image is available on this host.',
        sshKeyTitle: 'Select SSH key',
        sshKeyRequired: 'An SSH key is required. Add one in Profile before creating an hourly instance.',
        quoteTitle: 'Price preview',
        quoteUnavailable: 'The quote is temporarily unavailable.',
        hourlyPrice: 'Estimated hourly price',
        hour: 'hour',
        cpuCost: 'CPU cost',
        memoryCost: 'Memory cost',
        diskCost: 'Disk cost',
        reserveHint: '¥{amount} is reserved at creation; this price version took effect at {effectiveAt}.',
        createButton: 'Create hourly instance',
        createSuccess: 'Instance creation started. Check the details shortly.',
        detailTitle: 'Hourly billing',
        status: 'Billing status',
        statusActive: 'Active',
        statusPaused: 'Paused',
        statusSuspended: 'Suspended',
        statusClosed: 'Closed',
        hourlyRate: 'Current hourly price',
        prepaidBalance: 'Prepaid balance',
        totalCost: 'Total cost',
        totalReserved: 'Total reserved',
        outstandingAmount: 'Outstanding amount',
        nextSettlement: 'Next settlement',
        noNextSettlement: 'None',
        recentRecords: 'Recent settlements',
        recordPeriod: 'Settlement period',
        recordAmount: 'Actual cost',
        recordReserve: 'Reserved / released',
        noRecords: 'No settlement records',
        debtHint: 'The balance is insufficient and the instance is paused. Pay the outstanding amount to resume it.',
        payDebt: 'Pay debt and unsuspend',
        payDebtSuccess: 'Hourly debt paid and the instance was unsuspended.',
        loadFailed: 'Failed to load hourly billing information',
        adminTitle: 'Hourly billing management',
        adminDescription: 'Manage hourly price versions, running instances, and settlement jobs.',
        pricingTitle: 'Price versions',
        newPricing: 'Publish price version',
        enabled: 'Enable version',
        resourceUnit: 'Pricing unit',
        minimum: 'Minimum resources',
        pricePerUnit: 'Unit price',
        reserveQuantum: 'Reserve amount',
        effectiveAt: 'Effective at',
        savePricing: 'Publish price',
        savePricingSuccess: 'Price version published',
        versions: 'versions',
        instancesTitle: 'Hourly instances',
        reconcile: 'Run settlement',
        reconcileSuccess: 'Settlement job executed',
        refresh: 'Refresh',
        noInstances: 'No hourly instances',
        user: 'User',
        balance: 'Balance',
    ...
    // Official coupons (issued by the platform, discount borne by the platform, no AFF commission)
    officialCoupon: {
        label: 'Official Coupon',
        valid: 'Official coupon valid, {rate}% discount applied',
        using: 'You are using a platform official coupon',
        name: 'Coupon: {name}',
        benefit: 'This order gets {discount}% off, and the platform covers the discount',
        discountAmount: 'Official coupon discount',
    },
    ...
    instance: {
        ...
        forcePanelDeleteConfirm: 'The source host cannot be reached. Panel-only removal is allowed only for free instances, does not contact the host, and never issues a refund. Paid or hourly instances require confirmed remote deletion. Continue?',
        createPage: {
        ...
        subscription: {
            ...
            applyAffReplacedSuccess: 'Promo code updated. It will apply to your next renewal.',
            changeAffShort: 'Change Code',
            changeAffTitle: 'Change Renewal Promo Code',
            changeAffSubmit: 'Confirm Change',
            replaceOfficialCouponShort: 'Replace Coupon',
            applyAffCurrentCode: 'Current promo code',
            applyAffSourceAff: 'AFF promo code',
            applyAffSourceOfficial: 'Official coupon',
            applyAffReplaceHint: 'This instance already has a promo code. Confirming will replace the old code with the new one.',
            applyAffReplaceOfficialHint: 'This instance currently uses an official coupon for renewal discounts. Confirming will replace it with the AFF promo code.',
            applyAffNoStackHint: 'Promo codes do not stack.',
            applyAffNextRenewalHint: 'The promo code takes effect from the next unsettled renewal.',
            applyAffHistoryHint: 'Completed renewal bills will not be modified.',
            // Auto renew
        ...
        detail: {
            ...
            info: {
                ...
                suspendReasonTrafficBilling: 'Insufficient balance for usage-based traffic billing',
    ...
    admin: {
        ...
        system: {
            ...
            sections: {
                ...
                seo: {
                    title: 'Website SEO',
                    description: 'Manage Sitemap, search-engine verification files, IndexNow submission, and tracking scripts',
                },
                security: {
            ...
            seo: {
                title: 'Website SEO Management',
                description: 'Manage the Sitemap, search-engine verification file, IndexNow submission, and gtag tracking settings in one place.',
                siteUrl: 'Site URL',
                siteUrlHint: 'Used to generate canonical URLs, the Sitemap URL, and search-engine submission URLs.',
                sitemapPath: 'Sitemap path',
                invalidUrl: 'Enter a valid site URL and path first',
                indexNowEndpoint: 'IndexNow endpoint',
                indexNowKey: 'IndexNow key',
                indexNowKeyPlaceholder: 'For example, a generated IndexNow key',
                indexNowKeyHint: 'The key file is served at /{Key}.txt for search-engine verification.',
                submitIndexNow: 'Submit to IndexNow',
                submitting: 'Submitting...',
                submitSuccess: 'IndexNow submission succeeded; URLs submitted',
                submitFailed: 'IndexNow submission failed',
                openSearchConsole: 'Open Google Search Console',
                copySitemapUrl: 'Copy Sitemap URL',
                copySuccess: 'Sitemap URL copied',
                copyFailed: 'Copy failed; please copy it manually',
                submitHint: 'IndexNow notifies supported search engines. Google Sitemap submission can still be completed in Search Console.',
                verificationTitle: 'Search-engine verification file',
                verificationDescription: 'The server returns the configured verification content at the configured path; no frontend rebuild or manual upload is required.',
                verificationPath: 'Verification path',
                verificationContent: 'Verification file content',
                verificationContentPlaceholder: 'For example: google-site-verification: xxxxx',
                verificationHint: 'Use an .html or .txt file path. Leave the path empty to disable the verification file.',
                trackingTitle: 'Website tracking',
                trackingDescription: 'Load a gtag-compatible tracking script. Google Analytics 4 can be configured directly.',
                trackingEnabled: 'Enable website tracking',
        ...
        hosts: {
            ...
            databaseOnlyDelete: 'Panel-only delete (Free Only)',
            forcePanelDelete: 'Remove Panel Records (Free Only)',
            forcePanelDeleteConfirm: 'This mode does not contact the host and is allowed only for free instances. Paid or hourly instances require confirmed remote deletion and receive no refund in panel-only mode. Remove these {count} instance record(s)?',
            forcePanelDeleteHint: 'The host is offline. Panel-only removal is allowed only for free instances and never issues a refund; paid or hourly instances require confirmed remote Incus deletion.',
            ...
            batchDeleteSuccessWithRefund: 'Successfully deleted {count} instance(s); refund credited and recorded: ¥{amount}',
            batchDeletePartialWithRefund: 'Successfully deleted {success} instance(s), {failed} failed; refund credited and recorded: ¥{amount}',
        ...
        billing: {
            ...
            tabs: {
                ...
                officialCoupons: 'Official Coupons',
                paymentProviders: 'Payment Providers',
            },
            // Overview statistics
            ...
            databaseOnlyDelete: 'Panel-only delete (Free Only)',
            deleteRefundDatabaseOnlySuccess: 'Free instance removed from the panel',
            // Apply discount
        ...
        // Official coupons (discount borne by the platform, no AFF commission)
        officialCoupons: {
            title: 'Official Coupons',
            description: 'Platform-issued coupons: users pay the discounted price, the platform covers the discount, host owners are still settled at the original price, and no AFF commission is generated.',
            create: 'New Coupon',
            createTitle: 'New Official Coupon',
            editTitle: 'Edit Official Coupon',
            searchPlaceholder: 'Search coupon code, name or remark',
            ...
            name: 'Name',
            namePlaceholder: 'e.g. Black Friday 5% off',
            discount: 'Discount',
            discountPercent: 'Discount (%)',
            discountHint: 'Enter 5 for 5% off. The discount is calculated from the plan price.',
            scope: {
                all: 'All packages',
                official_only: 'Official packages only',
                hosted_only: 'Hosted packages only',
            },
            scopeLabel: 'Scope',
            usage: 'Used',
            usageUnlimited: '{used} used (no total limit)',
            usageLimited: '{used} / {limit} used',
            perUser: 'Per-user limit',
            perUserOnce: 'Once per user',
            perUserUnlimited: 'Unlimited per user',
            perUserTimes: 'Up to {count} times per user',
            renewalLabel: 'Renewal Discount',
            renewalMode: {
                purchase_only: 'First purchase only',
                limited: 'Limited discounted months',
                recurring: 'Recurring discount',
            },
            renewalModeLimitedTimes: 'Limited to {count} discounted months',
            discountedChargeLimit: 'Discounted Months (incl. first purchase)',
            discountedChargeLimitHint: 'e.g. 3 means 3 months including the initial purchase are discounted; extra months use the regular price.',
            validity: 'Validity',
            alwaysValid: 'Always valid',
            noStart: 'Starts immediately',
            noEnd: 'No end date',
            statusLabel: 'Status',
            enable: 'Enable',
            disable: 'Disable',
            ...
            usages: 'Usages',
            usagesTitle: 'Coupon Usage Records',
            usagesEmpty: 'No usage records yet',
            usageUser: 'User',
            usageInstance: 'Instance',
            usageOriginalPrice: 'Original Price',
            usageDiscount: 'Discount',
            usageTime: 'Used At',
            empty: 'No official coupons yet',
            remark: 'Remark',
            remarkPlaceholder: 'Internal note, admin only (optional)',
            startsAt: 'Starts At',
            startsAtHint: 'Leave empty to activate immediately.',
            expiresAt: 'Expires At',
            expiresAtHint: 'Leave empty for no end date.',
            totalUsageLimit: 'Total Usage Limit',
            totalUsageHint: 'Leave empty for unlimited total uses.',
            unlimitedPlaceholder: 'Empty = unlimited',
            reusable: 'Allow repeated use by the same user',
            reusableHint: 'When off, each user can use this coupon only once.',
            maxUsesPerUser: 'Max Uses Per User',
            maxUsesPerUserHint: 'Leave empty for unlimited uses per user.',
            enabledLabel: 'Enable this coupon',
            editUsageNotice: 'Coupons with usage records cannot be deleted, only disabled. Used count is never reset.',
            deleteUsedHint: 'Coupons with usage records cannot be deleted; disable it instead',
            deleteConfirm: 'Delete coupon {code}?',
            createSuccess: 'Official coupon created',
            updateSuccess: 'Official coupon updated',
            deleteSuccess: 'Official coupon deleted',
            validation: {
                nameRequired: 'Coupon name is required',
                discountInvalid: 'Discount must be greater than 0 and less than 100',
                maxUsesInvalid: 'Max uses per user must be an integer of at least 1',
                totalUsageInvalid: 'Total usage limit must be an integer of at least 1',
                rangeInvalid: 'Expires At must be later than Starts At',
                chargeLimitRequired: 'A positive integer is required for limited discounted months',
            },
        },
...
4. After creation, ticket details show the ticket ID, state, category, priority, host, and instance; closed tickets cannot receive replies. Never paste an SSH private key, password, or Agent secret into the content or attachments.`
    ...
    errors: {
        ...
        COUPON_NOT_FOUND: 'Official coupon not found',
        COUPON_DISABLED: 'This official coupon has been disabled',
        COUPON_NOT_STARTED: 'This official coupon is not active yet',
        COUPON_EXPIRED: 'This official coupon has expired',
        COUPON_SCOPE_MISMATCH: 'This official coupon does not apply to the selected package',
        COUPON_USER_LIMIT_REACHED: 'You have reached the usage limit for this official coupon',
        COUPON_EXHAUSTED: 'This official coupon has reached its total usage limit',
        COUPON_CODE_EXISTS: 'Official coupon code already exists',
        COUPON_IN_USE: 'Used official coupons cannot be deleted, disable it instead',
        COUPON_INVALID_DISCOUNT: 'Discount rate must be between 0 and 1',
    ...
    resources: {
        ...
        plans: {
            ...
            packageBilling: 'Fixed-cycle billing',
            hourlyBilling: 'Hourly billing',
            packageBillingHint: 'Charge the fixed price according to the plan billing cycle',
            hourlyBillingHint: 'Charge for the actual runtime of the resources configured in this plan',
            hourlyBillingOrderHint: 'Settled by runtime; ¥0.01 is reserved on start and the unused reserve is returned when stopped',
            hourlyBillingPriceHint: 'This plan has no fixed-cycle price; charges use this plan’s hourly rates and actual runtime.',
            hourlyPricingConfig: 'Hourly Pricing Configuration',
            hourlyPricingConfigHint: 'Pricing belongs to this plan; users are charged by actual running seconds. Amounts keep 8 decimals and display 2 decimals.',
            hourlyMinCpu: 'Minimum CPU',
            hourlyCpuUnit: 'CPU billing step',
            hourlyCpuPrice: 'CPU price per step (per hour)',
            hourlyMinMemory: 'Minimum memory',
            hourlyMemoryUnit: 'Memory billing step',
            hourlyMemoryPrice: 'Memory price per step (per hour)',
            hourlyMinDisk: 'Minimum disk',
            hourlyDiskUnit: 'Disk billing step',
            hourlyDiskPrice: 'Disk price per step (per hour)',
            ...
            trafficBillingMode: 'Traffic Billing Mode',
            packageTraffic: 'Included Traffic',
            usageTraffic: 'Usage Billing',
            includedTraffic: 'Free Traffic',
            trafficUnitPrice: 'Overage Unit Price',
            hourlySettlement: 'Settled when pending usage reaches 1 GB; the hourly fallback settles from 0.5 GB. The instance stops if balance is insufficient.',
            settlementHourly: '1 GB threshold + hourly 0.5 GB fallback',
            overageTraffic: 'Overage Traffic',
            settledTrafficCost: 'Settled Traffic Cost',
            pendingTraffic: 'Pending Traffic',
            nextSettlement: 'Next Settlement',
            trafficUnitPriceRequired: 'Usage billing price per GB must be greater than 0',
            packageTrafficRequired: 'Included package traffic must be greater than 0',
    ...
    host: {
        ...
        migrate: {
            ...
            forcePanelConfirm: 'Force migration from panel? The source host will not be contacted and its instances will not be deleted remotely. Only the target instances and panel records will be updated.',
    ...
    billing: {
        ...
        officialCouponDiscount: 'Official Coupon',
        currentDiscountSource: 'Current discount',
        noDiscount: 'None',
        addDiscountCode: 'Add Code',
        changeDiscountCode: 'Change Code',
        replaceOfficialCoupon: 'Replace Coupon',
        affCodeApplied: 'Promo code applied, effective from your next renewal',
