export default {
    ...
    admin: {
        ...
        hosts: {
            ...
            forcePanelDelete: 'Force Delete from Panel',
            forcePanelDeleteConfirm: 'The host may be unreachable. Force delete only removes the instance records from the panel and will not try to stop or delete instances on the host. Eligible paid hosted instances are still refunded and the balance changes are recorded. Delete these {count} instance(s)?',
            forcePanelDeleteHint: 'If the host is permanently offline, use “Force Delete from Panel”. This mode will not connect to the host or operate on its instances; it only cleans up the panel-side instance records while still processing eligible refunds and recording balance changes.',
        ...
        officialCoupons: {
            ...
            renewalMode: {
                ...
                limited: 'Limited charges',
                recurring: 'Recurring discount',
            },
            renewalModeLimitedTimes: 'Limited to {count} discounted charges',
            discountedChargeLimit: 'Discounted Charges (incl. first purchase)',
            discountedChargeLimitHint: 'e.g. 9 = first purchase plus 8 renewals are discounted; the 10th charge is at full price.',
            validity: 'Validity',
            ...
            validation: {
                ...
                chargeLimitRequired: 'A positive integer is required for limited discounted charges',
            },
        },
