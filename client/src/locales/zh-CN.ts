export default {
    ...
    admin: {
        ...
        hosts: {
            ...
            forcePanelDelete: '强制从面板删除',
            forcePanelDeleteConfirm: '节点可能无法通信。强制删除将只清理面板侧实例记录，不会尝试停止或删除主机上的实例；符合条件的付费托管实例仍会退款并记录余额变动。确定删除这 {count} 个实例吗？',
            forcePanelDeleteHint: '如果节点已彻底离线，请使用“强制从面板删除”。此模式不会连接节点或操作主机上的实例，只清理面板侧实例记录，并按规则执行退款和记录余额变动。',
        ...
        officialCoupons: {
            ...
            renewalModeLimitedTimes: '限定折价 {count} 次',
            discountedChargeLimit: '折价次数（含首次购买）',
            discountedChargeLimitHint: '例：填 9 表示含首次购买共折价 9 次，第 10 次起按原价续费。',
            validity: '有效期',
            alwaysValid: '长期有效',
            noStart: '立即生效',
            noEnd: '无结束时间',
            ...
            validation: {
                ...
                chargeLimitRequired: '限定折价次数模式下必须填写不小于 1 的整数',
            },
        },
